...
const Footer = () => {
  return (
    <div>
        <footer className="w-full bg-[#111f36] py-6 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="py-2 flex justify-between items-center flex-col gap-8 lg:flex-row">
        ...
        <div className="flex flex-col items-center lg:gap-0">
                    <ul className="flex flex-wrap justify-center gap-6 lg:gap-10 xl:gap-14 uppercase">
                        <li><a href="/" className="text-white hover:text-gray-400">Home</a></li>
                        <li><a href="/drawing" className="text-white hover:text-gray-400">Drawing</a></li>
                        <li><a href="/shop" className="text-white hover:text-gray-400">Shop</a></li>
                        <li><a href="/blog" className="text-white hover:text-gray-400">Blog</a></li>
                        <li><a href="/aboutus" className="text-white hover:text-gray-400">About us</a></li>
                    </ul>
                    <ul className="flex justify-center uppercase pt-3">
                        <li>
                ...
                <div className="flex  space-x-4 sm:justify-center  ">
                    <a href="javascript:;"  className="w-9 h-9 rounded-full  flex justify-center items-center hover:bg-indigo-600">
            ...
            <div className="py-2 border-t border-gray-700">
                <div className="flex items-center justify-center text-[11px]">
                    <span className="text-white "><a className='text-[#a6b3c0]' href="https://pagedone.io/">Copyright © 2024 </a>XStore theme . <a className='text-[#a6b3c0]' href="https://pagedone.io/">Created by 8theme </a>- WordPress WooCommerce themes</span>
                </div>
            </div>
    </footer>
    </div>
