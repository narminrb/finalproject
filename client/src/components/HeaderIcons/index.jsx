...
const HeaderIcons = () => {
  ...
  return (
    <div className="flex items-center gap-6 text-white font-extralight text-2xl relative">
      <button onClick={() => setIsSearchOpen(true)} className="hover:text-[#74a8b5] transition">
        <i className="ri-search-line"></i>
      </button>
      ...
      <div className="relative" ref={dropdownRef}>
        <button onClick={() => setIsDropdownOpen((prev) => !prev)} className="hover:text-[#74a8b5] transition">
          <i className="ri-user-3-line"></i>
        </button>
      ...
      <div className="relative">
        <Link to="/wishlist" className="hover:text-[#74a8b5] transition">
