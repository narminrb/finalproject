  ...
  return (
    <div className="bg-cover bg-center bg-no-repeat py-10">
      ...
      <div className="container max-w-screen-xl mx-auto px-3">
        <div className="flex items-center justify-between px-4 py-2 mb-6 text-gray-500">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`p-2 rounded cursor-pointer  ${
                  gridCols === 3 ? 'bg-gray-100 text-gray-500' : 'hover:bg-gray-100'
                }`}
              ...
              <button
                ...
                className={`p-2 rounded cursor-pointer ${
                  gridCols === 2 ? 'bg-gray-100 ' : 'hover:bg-gray-100'
                }`}
          ...
          <div className='flex justify-center'>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setShowCount(value === 'All' ? 'All' : Number(value));
              }}
                ...
                {selectedPainters.length > 0 ? (
                  <>
                    <button
                      ...
                      className="clear text-[#222] px-3 py-1"
                      type="button"
                    >
                      Clear All
                    </button>
